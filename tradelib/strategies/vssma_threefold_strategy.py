...
from tradelib.strategies.strategy_components.vssma_threefold_sma_component import VSSMAStraddleThreefoldComponent
...
from tradelib_global_constants import trade_interval_time, hedge_interval_time, OTM_outstrike, unwind_trade_side, strategy_trade_side, hedge_trade_side, m2m_side, hedge_by_option, signal_strat_time, signal_end_time, entry_cool_off_time, exit_cool_off_time, signal_tolerance, slow_lookback_period, fast_lookback_period

class VSSMAStraddleThreefoldStrategy(TradeStrategy):
    def __init__(self, trading_platform: TradingPlatform, portfolio: Portfolio, blotter: Blotter) -> None:
        super().__init__("vssma_straddle_dev_strategy", trading_platform, portfolio, blotter)
        ...
        strategy_component = VSSMAStraddleThreefoldComponent(trading_platform=trading_platform,
                                                    portfolio=self.portfolio,
                                                    blotter=self.blotter,
                                                    skip_count=1,
                                                    outstrike=OTM_outstrike,
