...
class StaticStrangleComponent(StrategyComponent):
    ...
    def __init__(self, trading_platform: TradingPlatform, portfolio: Portfolio, blotter: Blotter, skip_count:int, outstrike: float, execute_on_day_start:bool=True) -> None:
        super().__init__("static_strangle_component", trading_platform, portfolio, blotter, skip_count, execute_on_day_start)
