...
from tradelib.strategies.strategy_components.rsi_condor_component import RsiCondorComponent
...
class RsiCondorStrategy(TradeStrategy):
    def __init__(self, trading_platform: TradingPlatform, portfolio: Portfolio, blotter: Blotter) -> None:
        super().__init__("rsi_condor_strategy", trading_platform, portfolio, blotter)
        ...
        strategy_component = RsiCondorComponent(trading_platform=trading_platform,
                                                    portfolio=self.portfolio,
                                                    blotter=self.blotter,
                                                    skip_count=1,
