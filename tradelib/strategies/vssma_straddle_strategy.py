...
from tradelib.strategies.strategy_components.vssma_straddle_component import VSSMAStraddleComponent
...
class VSSMAStraddleStrategy(TradeStrategy):
    def __init__(self, trading_platform: TradingPlatform, portfolio: Portfolio, blotter: Blotter) -> None:
        super().__init__("vssma_straddle_strategy", trading_platform, portfolio, blotter)
        ...
        strategy_component = VSSMAStraddleComponent(trading_platform=trading_platform,
                                                    portfolio=self.portfolio,
                                                    blotter=self.blotter,
                                                    skip_count=1,
                                                    outstrike=OTM_outstrike,
