...
class DayofWeekStaticCondorStrategy(TradeStrategy):
    def __init__(self, trading_platform: TradingPlatform, portfolio: Portfolio, blotter: Blotter) -> None:
        super().__init__("day_of_week_static_condor_strategy", trading_platform, portfolio, blotter)
        ...
        day_of_week_static_condor_component = DayofWeekStaticCondorComponent(trading_platform, self.portfolio, self.blotter, trade_interval_time, OTM_outstrike, strategy_trade_side)

        self.add_component(day_of_week_static_condor_component)
