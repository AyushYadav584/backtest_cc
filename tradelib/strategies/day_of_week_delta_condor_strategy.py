...
from tradelib.strategies.strategy_components.day_of_week_static_condor_component import DayofWeekStaticCondorComponent
from tradelib.strategies.strategy_components.day_of_week_delta_condor_component import DayofWeekDeltaCondorComponent
from tradelib.strategies.strategy_components.day_of_week_balanced_condor_component import DayofWeekBalancedCondorComponent
...
from tradelib_global_constants import trade_interval_time, hedge_interval_time, OTM_outstrike, strategy_trade_side, hedge_trade_side, unwind_trade_side, m2m_side, delta_otm_tolerance, delta_outstrike, strict_condor, strict_tolerance, underlying, unit_size, unwind_time

class DayofWeekStaticDeltaStrategy(TradeStrategy):
    def __init__(self, trading_platform: TradingPlatform, portfolio: Portfolio, blotter: Blotter) -> None:
        super().__init__("day_of_week_delta_condor_strategy", trading_platform, portfolio, blotter)
        ...
        day_of_week_delta_condor_component = DayofWeekDeltaCondorComponent(trading_platform, self.portfolio, self.blotter, trade_interval_time, delta_outstrike, delta_otm_tolerance, strict_condor, strict_tolerance, underlying, unit_size, unwind_time, strategy_trade_side)

        self.add_component(day_of_week_delta_condor_component)
