...
from tradelib.strategies.strategy_components.day_of_month_dual_signal_static_condor_component import DayofMonthDualSignalStaticCondorComponent
...
class DayofMonthDualSignalStaticCondorStrategy(TradeStrategy):
    def __init__(self, trading_platform: TradingPlatform, portfolio: Portfolio, blotter: Blotter) -> None:
        super().__init__("day_of_month_dual_signal_static_condor_strategy", trading_platform, portfolio, blotter)
        ...
        day_of_month_static_condor_component = DayofMonthDualSignalStaticCondorComponent(trading_platform, self.portfolio, self.blotter, 1, OTM_outstrike, strategy_trade_side)
