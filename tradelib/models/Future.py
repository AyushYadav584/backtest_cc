...
#     def __init__(self, strike: int, expiry: date, delta: float, underlying: str, opt_type: str, instrument_type: str="future") -> None:
...
class Future(Instrument):
    def __init__(self, strike: int, expiry: date, underlying: str, opt_type: str, instrument_type: str="future") -> None:
        super().__init__(instrument_type, underlying)
        self.strike = int(strike)
        self.expiry = expiry
        self.dividend_rate = DIVIDEND_MAP[self.underlying]
